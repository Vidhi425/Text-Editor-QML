...
0x0,0x0,0x1,0x97,0x8c,0xf7,0xa3,0x85,
...
int QT_RCC_MANGLE_NAMESPACE(qInitResources_appTexteditor2_raw_qml_0)();
int QT_RCC_MANGLE_NAMESPACE(qInitResources_appTexteditor2_raw_qml_0)()
{
    int version = 3;
...
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_appTexteditor2_raw_qml_0)();
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_appTexteditor2_raw_qml_0)()
{
    int version = 3;
...
namespace {
   struct initializer {
       initializer() { QT_RCC_MANGLE_NAMESPACE(qInitResources_appTexteditor2_raw_qml_0)(); }
       ~initializer() { QT_RCC_MANGLE_NAMESPACE(qCleanupResources_appTexteditor2_raw_qml_0)(); }
   } dummy;
}
